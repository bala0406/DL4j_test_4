package com.example.dl4j_test_4;
    ...
    private class AsyncTaskRunner extends AsyncTask<Double, Integer, String>
    {
        ...
        protected String doInBackground(Double... params) {
            ...
            for(int r=0; r<rowLabel; r++)
            {
                ...
                {
                    twodimLabel[r][c]= ds.labelData[ii++];
                }
            }
        ...
        protected void onPostExecute(String result) {
            ...
            TextView setosa = (TextView) findViewById(R.id.textView1);
            TextView versicolor = (TextView) findViewById(R.id.textView2);
            TextView virginica = (TextView) findViewById(R.id.textView3);
